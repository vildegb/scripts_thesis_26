...
df <- gc_compartments[, c("GC", "E1_liver", "E2_liver", "E3_liver", "E1_gill", "E2_gill", "E3_gill")]

# Spearman correlation matrix
cor_matrix_s <- cor(df, method = "spearman", use = "complete.obs")
print(cor_matrix_s)

# Pearson correlation matrix
cor_matrix_p <- cor(df, method = "pearson", use = "complete.obs")
print(cor_matrix_p)
```
